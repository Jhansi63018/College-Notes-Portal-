...
$page_title='Reference Materials';$css_path='../assets/css/style.css';$home_path='dashboard.php';$logout_path='../logout.php';$role='student';include '../includes/header.php'; ?><div class="layout"><?php include '../includes/sidebar.php'; ?>
<h1 class="page-title">Reference Materials</h1><p class="breadcrumb">Home → Reference Materials</p>

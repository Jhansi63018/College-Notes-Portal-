...
$page_title='Question Papers';$css_path='../assets/css/style.css';$home_path='dashboard.php';$logout_path='../logout.php';$role='student';include '../includes/header.php'; ?><div class="layout"><?php include '../includes/sidebar.php'; ?>
<h1 class="page-title">Question Papers</h1><p class="breadcrumb">Home → Question Papers</p>
